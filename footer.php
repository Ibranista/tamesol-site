<footer class="footer_wrapper">
    ...
    <div class="lets_talk">
        ...
        <div class="btn_wrapper_lets">
            <button class="lets_talk_btn"><a href="<?php echo get_permalink(get_page_by_path('contact-us')); ?>" style="text-decoration:none;color:#fff;">LET'S TALK</a></button>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="footer-section">
            <div>
                ...
                <p>Email: <a href="<?php echo esc_url(home_url('/')); ?>" style="text-decoration:none;color:#fff;">tamesolcommunications.com</a></p>
